...
public class LevelIntroScreen implements Screen{
	...
	private LinkedList<String> getLevelText() {
		...
		case 1: {
			...
			levelText.add("You intercept a coded signal from a hidden branch of the military.");
			levelText.add("Earth wasn't destroyed.");
			levelText.add("The destruction you witnessed was an unprovoked attack on an alien civilization.");
			levelText.add("You were brainwashed and used you to fire the nukes. ");
			levelText.add("A Squad has been sent to retrieve you.");
		}
		case 2: {
			levelText.add("");
			levelText.add("");
