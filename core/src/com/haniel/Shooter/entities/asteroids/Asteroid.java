	...
	public void particles() {
		if( health < 0) {
			for (int i = 0; i < 10 * width; i++)
				gameScreen.add(new PurpleParticle((int) x + width / 2,(int) y + height / 2, 30));
				gameScreen.add(new PurpleParticle((int) x,(int) y + height / 2, 30));
				gameScreen.add(new PurpleParticle((int) x + width / 2,(int) y, 30));
				gameScreen.add(new PurpleParticle((int) x + width,(int) y + height, 30));
