...
public class BlueSaucer extends Enemy{
	...
	public BlueSaucer(double x, double y, CatmullRomSpline<Vector2> path, Level level) {
		...
		this.width = 140;
		this.height = 30;
		sprites.add(new Sprite(Assets.manager.get("entities/Level1/alien2.png", Texture.class)));
		sprites.add(new Sprite(Assets.manager.get("entities/Level1/alien2-1.png", Texture.class)));
		sprites.add(new Sprite(Assets.manager.get("entities/Level1/alien2-2.png", Texture.class)));
		sprites.add(new Sprite(Assets.manager.get("entities/Level1/alien2-3.png", Texture.class)));
		sprites.add(new Sprite(Assets.manager.get("entities/Level1/alien2-4.png", Texture.class)));
		sprites.add(new Sprite(Assets.manager.get("entities/Level1/alien2-5.png", Texture.class)));
	...
	public void particles() {
		if (health < 0) {
			PooledEffect effect = level.smallExplosionEffect2Pool.obtain();
